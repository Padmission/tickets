...
test('TicketCreatedEvent is dispatched with current user as actor', function () {
...
test('ticket assignment triggers event with current user as actor', function () {
    // Create ticket first
    $status = \Padmission\Tickets\Models\TicketStatus::first();
    $priority = \Padmission\Tickets\Models\TicketPriority::first();
